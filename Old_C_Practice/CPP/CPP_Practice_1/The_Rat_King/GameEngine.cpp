...
void displayPlayerAndEnemy(Player player, Enemy enemy){
	...
	*/
	system("CLS");
	cout << "\n    " << setw(8) << left << player.getName() << " Level: " << setw(50) << left << player.getLevel();
	cout << setw(10) << left << enemy.getName() << " Level: " << setw(2) << left << enemy.getLevel() << endl;
	cout << "    HP: " << setw(3) << right << player.getCurrHp() << "/" << setw(4) << left << player.getHp() << " XP: " << setw(53) << left << player.getXp();
	cout << "HP: " << setw(3) << right << enemy.getCurrHp() << "/" << setw(4) << left << enemy.getHp() << endl; 
}
